...
- Index building parameters
  ...
  | `params.bm25_k1`          | Controls the term frequency saturation. Higher values increase the importance of term frequencies in document ranking. | [1.2, 2.0] |
  | `params.bm25_b`           | Controls the extent to which document length is normalized. Defaults to 0.75. | [0, 1] |
