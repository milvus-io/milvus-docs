...
![Channels 1]({{images.assets/channels_1.jpg}} "Each shard corresponds to a vchannel.")
...
![Channels 2]({{images.assets/channels_2.jpg}} "Log broker nodes.")
...
![Index building]({{images.assets/index_building.jpg}} "Index building in Milvus.")
...
![Data query]({{images.assets/data_query.jpg}} "Data query in Milvus.")
...
![Handoff]({{images.assets/handoff.jpg}} "Handoff in Milvus.")
