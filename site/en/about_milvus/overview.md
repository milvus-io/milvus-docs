...
Milvus was released under the Apache 2.0 License and officially open sourced in October 2019. It is an incubation project under [LF AI & DATA](https://lfai.foundation/) Foundation. The source code of Milvus is hosted on [GitHub](https://github.com/milvus-io/milvus).
