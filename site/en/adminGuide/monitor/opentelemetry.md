...
id: opentelemetry.md
title: OpenTelemetry
related_key: monitor, alert, tracing, opentelemetry, observability
summary: Learn how to monitor Milvus operations using OpenTelemetry
---

# OpenLIT: OTel Auto Instrumentation for Milvus Python SDK

This topic describes how to use OpenLIT to generate OpenTelemetry Traces and Metrics to monitor Milvus operations.
...
### Step 2: Initialize OpenLIT in your code where you are using Milvus
