...
If you want to install Milvus with GPU support, download the installation file for Milvus [standalone](https://github.com/milvus-io/milvus/releases/download/v{{var.milvus_release_tag}}/milvus-standalone-docker-compose-gpu.yml) or [cluster](https://github.com/milvus-io/milvus/releases/download/v{{var.milvus_release_tag}}/milvus-cluster-docker-compose-gpu.yml), and save it as `docker-compose.yml`.
...
proxy:
    ...
    # Change this to "milvusdb/milvus:v{{var.milvus_image}} 
    # if you prefer to use Milvus without GPU support"
    image: milvusdb/milvus:v{{var.milvus_gpu_image}} 
