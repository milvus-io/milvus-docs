...
Vector indexes are an organizational unit of metadata used to accelerate [vector similarity search](search.md). You need to create an index before you can perform ANN searches in Milvus.
