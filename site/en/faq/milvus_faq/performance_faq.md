...
The `rootcoord.minSegmentSizeToEnableIndex` parameter determines the index-building threshold for a segment, and is set to {{var.index_building_threshold}} rows by default. See [System Configurations](configuration_cluster-advanced.md#System-Behavior-Configurations) for more information.
