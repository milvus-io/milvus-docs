...
#### Where can I find logs generated by Milvus?

By default log is directly print on stdout and stderr, we highly recommend you to redirect log to a persistent volume in production. To redirect log to specified path, you can change log-file-rootPath config in milvus.yaml file.
