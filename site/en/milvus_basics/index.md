...
<div class="alert note">
Index building parameters and search parameters may vary with Milvus distribution. Select your Milvus distribution first.
</div>
...
<div class="alert note">
If the value of <code>m</code> does not fall into the specified range for GPU indexing but falls into the range of CPU indexing, Milvus switches to using CPU to build index.
</div>
...
<div class="alert note">
If the value of <code>nprobe</code> does not fall into the specified range for GPU search but falls into the range of CPU search, Milvus switches to CPU search.
</div>
