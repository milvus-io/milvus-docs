...
> 如使用默认 [**milvus-standalone-docker-compose.yml**](https://github.com/milvus-io/milvus/releases/download/v{{var.cpu_milvus_docker_image_version}}/milvus-standalone-docker-compose.yml) 文件启动第三方服务，则无需修改该部分参数。
