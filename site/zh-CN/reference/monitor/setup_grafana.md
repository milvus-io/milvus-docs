...
你可以通过 Milvus 提供的 [Grafana 配置文件](https://github.com/milvus-io/docs/blob/master/v{{var.release_version}}/assets/monitoring/dashboard.json) 配置展示在 Grafana Dashboard 的以下各种指标：
