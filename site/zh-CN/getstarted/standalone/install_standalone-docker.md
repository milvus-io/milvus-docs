...
```
> 你可以在 GitHub 直接 [下载](https://raw.githubusercontent.com/milvus-io/milvus/{{var.cpu_milvus_docker_image_version}}/deployments/docker/standalone/docker-compose.yml) **docker-compose.yml**。
