...
This repository contains technical documentation for [Milvus](https://github.com/milvus-io/milvus), an open source similarity search engine designed by [Zilliz](https://zilliz.com).
